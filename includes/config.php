...
define( 'YOURLS_DB_USER', 'michaelwang' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', '8DCF*wtZ' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'michaelwang_yourls' );

/** MySQL hostname */
define( 'YOURLS_DB_HOST', 'mysql.michaelwang.cc' );
...
define( 'YOURLS_SITE', 'http://mkwng.com' );
...
$yourls_user_passwords = array(
	'mwang' => 'r4ch2inc86' // You can have one or more 'login'=>'password' lines
	);
